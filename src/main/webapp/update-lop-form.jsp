...
<div>
	...
	<tr>
		...
		<td><input type="text" name="ma_lop" value="${the_lop.maLop }" readonly></td>
	</tr>
	<tr>
		<td><label>Ten Lop:</label></td>
		<td><input type="text" name="ten_lop" value="${the_lop.tenLop }"></td>
	</tr>
	<tr>
		<td><label>Day Nha:</label></td>
		<td><input type="text" name="day_nha" value="${the_lop.dayNha }"></td>
	</tr>
	<tr>
		<td><label></label></td>
